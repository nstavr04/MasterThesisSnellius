#!/bin/bash
#SBATCH --job-name=inferencetime           # Job name
#SBATCH --output=logs/inferencetime_%j.log         # Standard output and error log (%j is the job ID)
...
# Run
uv run count_inference_time.py