#!/bin/bash
#SBATCH --job-name=testtesting1           # Job name
#SBATCH --output=logs/testing_%j.log         # Standard output and error log (%j is the job ID)
...
srun rye run python test_precip_lightning.py